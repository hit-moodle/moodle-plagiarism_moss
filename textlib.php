...
// §£§Ö§â§ã§Ú§ñ 0.3
// Author: §¡§Ý§Ö§Ü§ã§Ö§Û §²§Ö§Þ§Ò§Ú§ê a.k.a Ramon
...
function getCharTransformations(&$transformations, $stream) {
    ...
    //   a corresponding value from [ ]: 0000 -> abcd, 0001 -> 0123 4567, §Ñ 0002 -> 8900.
...
// Why do we need it? This format serves as a basement for such "delicious" formats as .doc, .xls §Ú .ppt. 
...
class cfb {
    ...
    // The number of miniFAT-sectors and position of sequences of miniFAT-§ãsectors in the file
    private $cMiniFAT = 0;
    private $fMiniFAT = 0;
	...
	public function read_content($filename)
	{
		$this->data = $filename;
	}
    ...
    public function parse() {
        ...
        // After all this we should be able to work with any of the "upper" formats from Microsoft such as doc, xls §Ú§Ý§Ú ppt.
    }
        ...
        for ($i = 0; $i < strlen($in); $i += 2) { 
           ...
           if (ord($cd[1]) == 0) { 
                ...
                elseif (ord($cd[0]) == 0x13) 
                    ...
                    continue; 
                    // §£ §á§â§à§ä§Ú§Ó§ß§à§Þ §ã§Ý§å§é§Ñ§Ö §á§â§à§Ó§Ö§â§ñ§Ö§Þ §ã§Ú§Þ§Ó§à§Ý§í §ß§Ñ §Ó§ß§Ö§Õ§â§×§ß§ß§í§Ö §Ü§à§Þ§Ñ§ß§Õ§í (§ã§á§Ú§ã§à§Ü §Þ§à§Ø§ß§à 
                    // §Õ§à§á§à§Ý§ß§Ú§ä§î §Ú §á§à§á§à§Ý§ß§Ú§ä§î). 
                    switch (ord($cd[0])) { 
            ...
            } else { // §ª§ß§Ñ§é§Ö §á§â§Ö§à§Ò§â§Ñ§Ù§à§Ó§í§Ó§Ñ§Ö§Þ §Ó HTML entity 
                if (ord($cd[1]) == 0x13) { 
                    echo "@"; 
                    $skip = true; 
                    continue; 
...
class doc extends cfb {
    ...
    public function parse() {
        ...
        // §±§à§ä§à§Þ §ß§Ñ§ç§à§Õ§Ú§Þ §Ó §á§à§ä§à§Ü§Ö CLX
        ...
        // for the possible beginning of pieceTable (it must start with  0§ç02), and read the following 4 bytes
        ...
        $from = 0;
        // Looking for  0§ç02 in CLX starting from the current offset
...
// Version 0.3
// Auhtor: §¡§Ý§Ö§Ü§ã§Ö§Û §²§Ö§Þ§Ò§Ú§ê a.k.a Ramon
// E-mail: alex@rembish.ru
// Copyright 2009
